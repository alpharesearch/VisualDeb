 ...
 * VisualDebFiles/PackageManpages.vala - Copyright (C) 2010  Markus Schulz
 *
...
namespace VisualDebFiles
{
	...
	public class PackageManpages : DebianFiles
	{
...
public Type register_plugin (TypeModule module) {
    ...
    return typeof (VisualDebFiles.PackageManpages);
}
